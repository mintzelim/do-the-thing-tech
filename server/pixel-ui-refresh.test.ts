...
describe("mascot-led audience grid", () => {
  it("keeps five audience groups with mascot-only image assets and preserved audience copy", () => {
    ...
    expect(homeContent).toContain("audience-howitworks-students_efaed790.png");
    expect(homeContent).toContain("audience-howitworks-remote-workers_fbec123a.png");
    expect(homeContent).toContain("audience-howitworks-employees_a4707f6a.png");
    expect(homeContent).toContain("audience-howitworks-project-managers_1d2feb2f.png");
    expect(homeContent).toContain("audience-howitworks-parents_a908291e.png");

...
// Test the timer adjustment logic that's used in TimerContext
describe('Timer Adjustment Logic', () => {
  ...
  it('should handle multiple check/uncheck cycles', () => {
    // Initial: 3 tasks × 300 seconds = 900 seconds
    timeRemaining = 900;
    timerActive = true;

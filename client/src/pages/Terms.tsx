      ...
      <div className="mobile-content">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mobile-card" style={{ marginBottom: "20px" }}>
            <h2 className="mobile-heading-2">Last Updated: April 2026</h2>
            
            <div className="mobile-body" style={{ marginTop: "16px", lineHeight: "1.8" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>1. Use License</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>2. Disclaimer</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>3. Limitations</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>4. Accuracy of Materials</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>5. Links</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>6. Modifications</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>7. Governing Law</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>8. Contact Information</h3>
              <p style={{ marginBottom: "16px" }}>

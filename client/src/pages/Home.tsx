...
export default function Home() {
  ...
  // Update browser metadata on client-side navigation. The complete FAQ schema is
  // emitted in the server-rendered document for crawler and link-preview visibility.
  useEffect(() => {

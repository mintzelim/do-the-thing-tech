  ...
  return (
    <div className="mobile-frame geo-page">
      ...
      <main className="geo-shell">
        <section className="geo-hero" aria-labelledby="comparison-heading">
          <p className="geo-eyebrow">HONEST TOOL SELECTION</p>
          <h1 id="comparison-heading">DOTHETHING VS. GOBLIN.TOOLS MAGIC TODO</h1>
        ...
        <section className="geo-comparison-note" aria-label="Comparison standard"><p><strong>How to read this page:</strong> it compares observable workflows and stated features, not clinical outcomes or a universal “best” tool. Interfaces change, so use the linked primary sources when choosing.</p></section>

        <section className="geo-screenshot-section" aria-labelledby="screens-heading">
          ...
          <div className="geo-screenshot-grid">
          ...
          <p className="geo-source-note">Screenshots show the public interfaces viewed on 13 August 2026. The Goblin.tools screen is shown for factual comparison and links to its official product page below.</p>
        </section>

        <section className="geo-ledger" aria-labelledby="ledger-heading">
          ...
          <div className="geo-table-wrap"><table><thead><tr><th scope="col">Decision point</th><th scope="col">DoTheThing</th><th scope="col">Goblin.tools Magic ToDo</th></tr></thead><tbody>
        ...
        <section className="geo-fit-grid" aria-labelledby="fit-heading">
          ...
          <article><p className="geo-label">TRY DOTHETHING IF…</p><h3>You want a calmer first screen and one integrated execution path</h3><p>It may fit when you benefit from large, high-contrast task text; want to choose a focus level and task size before the plan is made; and want a visible timer and completion queue in the same workflow.</p><a href="/">START A TASK <span aria-hidden="true">→</span></a></article>
          <article><p className="geo-label">TRY GOBLIN.TOOLS IF…</p><h3>You want a wider toolbox, shared lists, or communication support</h3><p>It may fit when you want its collection of focused utilities, account-based history and sharing, or tools such as Formalizer, Judge, Compiler, and its dedicated Estimator and Taskmaster.</p><a href="https://goblin.tools/ToDo" target="_blank" rel="noopener noreferrer">VISIT MAGIC TODO <span aria-hidden="true">↗</span></a></article>
        </section>

        <section className="geo-citation-strip" aria-label="Comparison sources"><p>Primary sources: <a href="https://goblin.tools/" target="_blank" rel="noopener noreferrer">Goblin.tools home</a> and <a href="https://goblin.tools/ToDo" target="_blank" rel="noopener noreferrer">Magic ToDo</a>. DoTheThing descriptions reflect the live product workflow and <a href="/how-it-works">documented product boundaries</a>.</p></section>
      </main>
      <Footer />
    </div>
  );

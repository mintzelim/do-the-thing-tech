        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mobile-card" style={{ marginBottom: "20px" }}>
            ...
            <div className="mobile-body" style={{ marginTop: "16px", lineHeight: "1.8" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Information Collection and Use</h3>
              <p style={{ marginBottom: "16px" }}>
                We collect several different types of information for various purposes to provide and improve our Service to you.
              </p>

              <h4 style={{ fontWeight: "bold", marginTop: "16px", marginBottom: "8px" }}>Types of Data Collected:</h4>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Use of Data</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Security of Data</h3>
              <p style={{ marginBottom: "16px" }}>
                The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
              </p>

              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Third-Party Services</h3>
              <p style={{ marginBottom: "16px" }}>
              ...
              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Changes to This Privacy Policy</h3>
              <p style={{ marginBottom: "16px" }}>
                We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date at the top of this Privacy Policy.
              </p>

              <h3 className="mobile-heading-3" style={{ marginTop: "24px", marginBottom: "12px" }}>Contact Us</h3>
              <p style={{ marginBottom: "16px" }}>

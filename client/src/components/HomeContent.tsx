      ...
      <section className="content-section audience-section">
        ...
        <div className="audience-grid">
          <article className="audience-card">
            <img className="audience-card-mascot" src="/manus-storage/audience-students-pixel_2d951eff.png" alt="" aria-hidden="true" />
            <h3>Students</h3>
            <p><strong>Students:</strong> Bypassing academic overwhelm and the "blank page" syndrome.</p>
          </article>
          <article className="audience-card">
            <img className="audience-card-mascot" src="/manus-storage/audience-remote-workers-pixel_8d16b289.png" alt="" aria-hidden="true" />
          ...
          <article className="audience-card">
            <img className="audience-card-mascot" src="/manus-storage/audience-employees-pixel_fd8e9c6e.png" alt="" aria-hidden="true" />
          ...
          <article className="audience-card">
            <img className="audience-card-mascot" src="/manus-storage/audience-project-managers-pixel_2948b15c.png" alt="" aria-hidden="true" />
          ...
          <article className="audience-card">
            <img className="audience-card-mascot" src="/manus-storage/audience-parents-pixel_9c34099b.png" alt="" aria-hidden="true" />
            <h3>Parents</h3>

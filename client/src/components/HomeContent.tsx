    ...
    <div className="home-content-sections">
      ...
      <section className="content-section">
        ...
        <div className="section-content">
          ...
          <p>
            That gap between wanting and starting has a name: <strong>Executive dysfunction</strong>. It's the planning circuit that should fire and doesn't, the initiation signal that arrives late or not at all. It's how ADHD works. And every app that hands you a blank list and says "prioritise this" is asking the wrong brain to do the wrong job.
          </p>
          <p>
      ...
      <section className="content-section">
        ...
        <div className="faq-list">
          ...
          <div className="faq-item">
            ...
            <p>Task paralysis is when an ADHD brain freezes in front of a task it understands. It's a neurological response to ambiguity — the brain can't generate a first step, so it generates nothing. DoTheThing removes the ambiguity by handing you a step small enough that starting stops feeling like a risk.</p>
          </div>
          <div className="faq-item">
            <h3>What is time blindness?</h3>
            <p>Time blindness is the ADHD brain's genuine difficulty sensing how long things take and how fast time passes. Estimates end up too optimistic, schedules collapse. DoTheThing adds a 20–30% buffer to every estimate and gives you a visual countdown timer so time stays concrete.</p>
          </div>
          <div className="faq-item">

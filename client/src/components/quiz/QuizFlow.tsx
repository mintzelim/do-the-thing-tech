...
export const ADHD_TYPE_RESULTS: Record<QuizTypeKey, Omit<QuizResult, 'resultKey' | 'score'>> = {
  classic: { type: 'The Spark Starter', sourceLabel: 'Classic ADD', character: 'The "Quest-Chaser" pattern', description: 'You spot a thing that needs doing and your brain presses the big green GO button. Starting is easy; the boring middle and the last ten percent may feel like a completely different sport.' },
  inattentive: { type: 'The Thought Wanderer', sourceLabel: 'Inattentive ADD', character: 'The "High Ping" pattern', description: 'Your brain has plenty to say, but a task can quietly wander off-screen when it is boring, invisible, or not happening right now. That does not mean you do not care.' },
  overfocused: { type: 'The Deep-Dive Mind', sourceLabel: 'Overfocused ADD', character: 'The "Strong Grip" pattern', description: 'Once your brain grabs an idea, it can hold on with both hands. That focus can be brilliant; changing channels can feel like being asked to leave a good book on the last page.' },
  temporal: { type: 'The Signal Catcher', sourceLabel: 'Temporal Lobe ADD', character: 'The "Time-Blind" pattern', description: 'You may notice timing, tone, memory clues, and feelings very quickly. Useful? Absolutely. A bit like having the volume set higher than everyone else? Also possible.' },
  limbic: { type: 'The Mood-Powered Mind', sourceLabel: 'Limbic ADD', character: 'The "Low-gear" pattern', description: 'Some days, a normal task looks normal. On other days, replying to one email looks like climbing a mountain in flip-flops. Your energy and mood can change the size of the job.' },
  ringOfFire: { type: 'The Many-Tabs Mind', sourceLabel: 'Ring of Fire ADD', character: 'The "Many Tabs" pattern', description: 'Your brain can feel like sixteen tabs are playing at once: ideas, noise, energy, reminders, and one mystery thought from 2014. It is a lot of input, not a personal failure.' },
  anxious: { type: 'The Careful Scout', sourceLabel: 'Anxious ADD', character: 'The "Careful Thought" pattern', description: 'Your brain is excellent at spotting what could go wrong. That can make you thoughtful and prepared—and it can also send you on a midnight fact-finding mission when a simple answer would do.' },
};

...
excerpt: >-
  93% of ADHD adults experience burnout. It's neurologically distinct. Here's
...
sources:
  ...
  - title: 'Healthline — ADHD Burnout: Causes, Signs, Management'
...
faq:
  - q: How long does ADHD burnout last?
    a: >-
      Acute symptoms improve within 1-2 weeks of rest. Full recovery takes 6-12
      weeks — longer than regular burnout because it requires rebuilding
      executive function systems.
  - q: Is ADHD burnout the same as depression?
    a: >-
      No. Burnout is situational, tied to exhaustion from sustained
      compensation. Depression is a mood disorder with different mechanisms.
  - q: Can medication help with ADHD burnout?
    a: >-
      Yes, carefully. Stimulants regulate dopamine but crashes can worsen the
      hyperfocus-collapse cycle. Medication review with a burnout-informed
      specialist recommended.
  - q: Why doesn't rest fix ADHD burnout?
    a: >-
      The cause isn't just sleep debt. It's dopamine dysregulation and executive
      function depletion. Rest stops the bleeding; recovery requires active
      rebuilding.
  - q: How do I know if I'm in burnout or procrastinating?
    a: >-
      Procrastination is avoiding a task you can do. Burnout is being unable to
      start a task you want to do.
...
## 6 Signs You're in Burnout (Not Just Tired)

| Sign | What It Looks Like |
|------|-------------------|
| Executive function collapse | Can't start normal tasks. Simple decisions impossible. |
| Emotional sensitivity spike | Small criticism hits like a punch. Snapping. |
| Sensory overwhelm | Noises you usually tolerate become unbearable. |
| The crash that doesn't lift | 9 hours sleep. Still exhausted. |
| Loss of interest | Hobbies feel empty. |
| Shutdown mode | Stop responding. Cancel plans. Sit and stare. |

Porto et al. (2024) found inattention specifically correlated with emotional exhaustion and depersonalization in 751 students.
...
- **ADHD burnout is neurobiological, not character failure.** Driven by dopamine dysregulation and EF overload.
...
https://www.scielo.br/j/paideia/a/QDChkNWLTCCxf7tzthD38hr/

...
## Tool 1: DoTheThing — AI Task Breakdown

**Best for:** Task initiation. The moment before you can start.
...
## Tool 2: Todoist — Ongoing Task Management
...
## Tool 3: Forest — Gamified Focus Timer

**Best for:** Staying off your phone during work sessions.
...
**Best for:** [Task paralysis](https://add.org/adhd-paralysis/) rooted in emotional avoidance, not structural confusion.
...
| Tool | Primary ADHD problem it solves | Free? | Works without signup? |
|:---|:---|:---:|:---:|
| DoTheThing | Task initiation, task breakdown, time blindness | ✅ | ✅ |
| Todoist | Ongoing task management, recurring tasks | Free tier | ❌ |
| Forest | Phone distraction, focus sessions | Free (Android) | ❌ |
| Focusmate | [Task paralysis](https://add.org/adhd-paralysis/), accountability, body doubling | 3 sessions/week free | ❌ |
| Google Calendar | Time blocking, scheduling, time blindness | ✅ | ❌ (Google account) |

---

## Frequently Asked Questions

### What is the best free app for ADHD task management in 2026?
...
### How does DoTheThing differ from other ADHD task apps?

Most task apps require you to do the breakdown yourself — they're organisers, not problem-solvers. DoTheThing automates the hardest step: deciding what to do first. You type the task, choose your focus level (hyperfocused, normal, or distracted), and get a numbered list of micro-steps back with ADHD-buffered time estimates. It removes the executive function demand that sits at the start of every task.

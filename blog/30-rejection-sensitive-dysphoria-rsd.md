---
id: '30'
title: "Rejection Sensitivity and ADHD: What People Mean by RSD and What May Help"
description: "RSD is a popular, non-diagnostic term for intense reactions to real or perceived rejection. Learn how to pause, check the story, and seek appropriate support."
slug: "rejection-sensitive-dysphoria-rsd"
excerpt: "Rejection sensitivity can feel immediate and consuming. This guide separates lived experience from diagnosis and offers a small, reversible plan for the moment a reaction hits."
date: "July 17, 2026"
updatedDate: "2026-08-24"
readTime: "9 min read"
category: "ADHD Basics"
primaryEntity: "Rejection sensitivity"
secondaryEntities:
...
sources:
  ...
  - title: "Cleveland Clinic, Rejection Sensitive Dysphoria"
  ...
  - title: "The Conversation, What is rejection sensitive dysphoria in ADHD?"
...
faq:
  - q: "What is rejection sensitive dysphoria (RSD)?"
    a: "RSD is a popular term for an intense reaction to real or perceived rejection, criticism, or failure. It is not a formal DSM diagnosis, and strong reactions can have many possible causes."
  - q: "Is RSD the same as being sensitive?"
    a: "No single reaction can separate normal hurt, rejection sensitivity, anxiety, trauma responses, mood changes, or other experiences. A clinician can help when the pattern is frequent, distressing, or disruptive."
  - q: "Is RSD part of ADHD?"
    a: "Emotional regulation difficulties and rejection sensitivity are discussed in ADHD research and lived experience, but RSD is not an official diagnostic criterion and is not universal among people with ADHD."
  - q: "What can help in the moment?"
    a: "Pause before replying, name the feeling without treating it as proof, check for another explanation, and choose one small reversible action. Seek urgent help if you feel unsafe."
  - q: "Is there medication for RSD?"
    a: "Only a qualified prescriber can discuss whether any medication is appropriate for you. This guide does not recommend starting, stopping, or changing medication for rejection sensitivity."
---

# Rejection Sensitivity and ADHD: What People Mean by RSD and What May Help

![Pixel-art illustration showing a pause before responding to a difficult social cue](/manus-storage/body-30-rejection-grounding_9c698db3.png)
...
- **RSD is descriptive language, not a DSM diagnosis.**
- **Some people with ADHD describe strong rejection sensitivity; others do not.**
- **A feeling can be real without being evidence of another person’s intention.**
- **The first goal is to make a response reversible:** pause, regulate, verify, then decide.
- **Frequent or overwhelming distress deserves qualified support.**
...
You may also find related practical guidance in our articles on [ADHD and emotional dysregulation](/blog/adhd-and-emotional-dysregulation), [ADHD and anxiety](/blog/adhd-and-anxiety), and [ADHD burnout](/blog/adhd-burnout).
